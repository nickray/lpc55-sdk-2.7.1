...
- ahb:
  - regions:
    ...
    - relative_region: {memory: SRAM3, security: ns_user, start: '0x00000000', size: '0x00001000'}
    - relative_region: {memory: SRAM3, security: s_priv, start: '0x00001000', size: '0x0000F000'}
    - relative_region: {memory: SRAM4, security: s_priv, start: '0x00000000', size: '0x00004000'}
    - relative_region: {memory: USB_RAM, security: ns_user, start: '0x00000000', size: '0x00004000'}
  - masters:
    - ns_user: {id: HASH, id: PQ, id: SDIO, id: SDMA0, id: SDMA1, id: USBFSD, id: USBFSH}
    - s_priv: {id: MCM33C, id: MCM33S}
  - peripherals:
    - ns_user: {id: ADC0, id: AHB_SECURE_CTRL, id: ANACTRL, id: CASPER, id: CRC_ENGINE, id: CTIMER0, id: CTIMER1, id: CTIMER2, id: CTIMER3, id: CTIMER4, id: DBGMAILBOX,
      ...
      id: GPIO, id: HASHCRYPT, id: INPUTMUX, id: MRT0, id: OSTIMER, id: PINT, id: PLU, id: PMC, id: POWERQUAD, id: PRINCE, id: PUF, id: RNG, id: RTC, id: SCT0, id: SDIF,
      id: SECGPIO, id: SECPINT, id: SPI8, id: SYSCTL, id: USB0, id: USBFSH, id: USBHSD, id: USBHSH, id: USBPHY, id: UTICK0, id: WWDT}
    - s_priv: {id: FLEXCOMM0, id: IOCON, id: MAILBOX, id: SYSCON}
  - interrupts:
    - masking:
...
void BOARD_InitTrustZone()
{
    ...
    AHB_SECURE_CTRL->MASTER_SEC_LEVEL        = 0x000000F0U;
    AHB_SECURE_CTRL->MASTER_SEC_ANTI_POL_REG = 0x3FFFFF0FU;

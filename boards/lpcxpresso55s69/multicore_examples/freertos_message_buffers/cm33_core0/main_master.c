...
static void FreeRtosMessageBuffersEventHandler(uint16_t eventData, void *context)
{
    ...
    arrive. */
        xMessageBufferSendCompletedFromISR(xSecondaryToPrimaryMessageBuffer, &xHigherPriorityTaskWoken);
    }
...
{
    volatile uint16_t RemoteAppReadyEventData = 0;
    size_t xReceivedBytes;

    memset((void *)APP_SH_MEM_BASE, 0, SH_MEM_TOTAL_SIZE);
